...
def create_admin_user(admin_user: AdminUserCreate, db: Session = Depends(get_db),token: str = Depends(oauth2_scheme)):
    """
...
def read_admin_user(db: Session = Depends(get_db),token: str = Depends(oauth2_scheme)):
    """
...
def delete_admin_user(id: int, db: Session = Depends(get_db),token: str = Depends(oauth2_scheme)):
    """
